...
import com.sda.Final.Project.service.IServiceImpl.INotificationService;
...
public class NotificationService implements INotificationService {
    ...
    public void save(NotificationDTO notificationDTO) {
        ...
        if (!meetingEntityOpt.isPresent()) {
            throw new NotFoundException("Notification for this meeting cannot be created because meeting does not exist.");
        }
