...
public class MeetingService implements iMeetingService {
    ...
    public void save(MeetingDTO meetingDTO) {
        ...
        sendMail(m, "Meeting confirmation", "Dear " + meetingDTO.getIdClientMeeting().getName() + "\nYour meeting is confirmed on " + meetingDTO.getStartDateAndHour() + ".\nBest regards,\nSuperior Business Card Team");
    }
    ...
    @Override
    public void update(MeetingDTO meetingDTO, Integer id) {
        ...
        if(meetingEntityOptional.isPresent()){
            ...
            sendMail(meetingEntity, "Meeting update", "Dear" + meetingEntity.getIdClientMeeting().getName() + "\nYour meeting is confirmed on " + meetingEntity.getStartDate() + ".\nBest regards,\nSuperior Business Card Team");
        }else {
